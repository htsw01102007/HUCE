...
$('.navbar-collapse a.open_window').click(function () {
    $(".navbar-collapse").collapse('hide');
});

function HideBoxSearch() {
    $('.btn-hide-search').toggleClass('Open');
    $('#box-search-hide').slideToggle('slow');
}

function HideBoxSearchExtend() {
    $('.btn-hide-search-extend').toggleClass('Open');
    $('#box-search-hide-extend').slideToggle('slow');
}

function HideSendMail() {
    $('.inbox .inbox-sidebar .inbox-nav').slideToggle('slow');
}

$("#btnTimNangCao").click(function () {
    $(".box-searchnangcao").slideToggle('slow');
});